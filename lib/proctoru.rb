...
module Proctoru
  ...
  class << self
    api_methods = %w( getTimeZoneList getEmailExist getScheduleInfoAvailableTimesList addAdHocProcess pendingExamReport autoLogin getTOS agreeToTOS removeReservation moveReservation )
